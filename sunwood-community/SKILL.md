...
description: "Sunwood AI OSS Hub (https://x.com/i/communities/2010195061309587967) への投稿専用スキル。解説付き投稿やスレッド投稿に使用。AIによる自動解説生成、文脈理解機能を搭載。"
---
...
- 元ポストURLや関連URLは本文ではなくリプライに分ける
- URLを本文に入れたい場合は現在の投稿ルールと競合する
